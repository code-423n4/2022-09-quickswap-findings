+ Pre-increment/pre-decrement consumes less gas than post-increment/post-decrement.
...
+ You don't have to examine <array>.length in each loop of the for loop

https://github.com/code-423n4/2022-09-quickswap/blob/15ea643c85ed936a92d2676a7aabf739b210af39/src/core/contracts/libraries/DataStorage.sol#L307

+ Values ​​greater than 0 are more expensive than !=0
...
+ To save gas, use private instead of public for constants.
...
+ It is recommended to use custom errors instead of REVERT()/REQUIRE() to save gas.
...
+ ABI.ENCODE() is less capable than ABI.ENCODEPACKED()
...
+ Boolean values ​​require storage overhead.
...
+ Use memory for structures and arrays instead of memory
...
+ Do not load variables with default values
