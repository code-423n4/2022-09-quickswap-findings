# 1. ++i is more efficient than i++

Code: https://github.com/code-423n4/2022-09-quickswap/blob/15ea643c85ed936a92d2676a7aabf739b210af39/src/core/contracts/libraries/DataStorage.sol#L307

Explanation: i++ returns the current value of i, and then increments it. ++i directly increments it, saving some gas.

# 2. !=0 is more efficient than >0 for uints in require statements
...
Explanation: require(a != 0) is more gas efficient than require(a > 0) and serves the same purpose when a is uint.