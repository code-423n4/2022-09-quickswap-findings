Using mutiple require statements is cheaper than using `&&` multiple check combinations. 
There are more advantages such as easier to read code and better coverage reports.

Optimizable Code location: 
...
https://github.com/code-423n4/2022-09-quickswap/blob/15ea643c85ed936a92d2676a7aabf739b210af39/src/core/contracts/libraries/TickMath.sol#L67

Solution:
Split the form of `require(A && B && C)` into the following writing:
```
require(A);
require(B);
require(C);
