...
2 You don´t have to looked up in every loop of a for-loop the <array>.length
https://github.com/code-423n4/2022-09-quickswap/blob/15ea643c85ed936a92d2676a7aabf739b210af39/src/core/contracts/libraries/DataStorage.sol#L307

3 Request instead of &&
...
5 To save gas it is better to use custom errors instead of REVERT()/REQUIRE(). Additionally, not characterizing strings saves the organization gas
...
7 To save gas you should use privete for constants, don´t use public.
...
8 Use a later version of solidity
...
9 Bools require overhead for storage.
...
10 Using storage for structs and arrays rather than Memory
